...
class ParallelSampler():
    def __init__(self, data, args, num_episodes=None):
        ...
        if self.num_classes < self.args.way:
            print( 'hi', colored(self.all_classes, 'green'), colored(self.args.way, 'magenta'), self.data['label'], set(self.data['label']) )
        ...
        # print('idx_list', self.idx_list[0])
        # print('data label', self.data['label'])
        # exit()
    ...
    def worker(self, done_queue):
        ...
        while True:
            ...
            # print('support_idx', support_idx); exit()
            ...
            fields_to_keep = ['text', 'text_len', 'label', 'ids']
